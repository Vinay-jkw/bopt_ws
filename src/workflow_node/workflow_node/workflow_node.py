...
ROBOT_ID = os.getenv("ROBOT_ID", "bopt") 
...
class SafetyPublisher(Node):
    def __init__(self):
        ...
        self.publisher_ = self.create_publisher(String, '/bopt/safety', 10)
        self.safety_switch_publisher = self.create_publisher(String, '/bopt/safety', 10)

        self.cmd_vel_pub = self.create_publisher(Twist, '/cmd_vel', 10)
        self.task_publisher = self.create_publisher(String, '/bopt/current_task', 10)
        self.state_publisher = self.create_publisher(String, '/bopt/status', 10)
...
def main(args=None):
    ...
    robot_id = os.getenv('ROBOT_ID', 'bopt')  # Default to 'bopt' if not set
    defaults = {
        "database_path": "/home/jkw/bopt_ws/src/workflow_node/map_details/demo_map_wn.db",
        "graphml_path": "/home/jkw/bopt_ws/src/workflow_node/map_details/demo_map_waypoints.graphml",
