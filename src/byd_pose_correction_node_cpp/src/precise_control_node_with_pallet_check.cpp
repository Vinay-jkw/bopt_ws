...
public:
    VelocityAndSteeringPublisher() : rclcpp::Node("velocity_and_steering_pub") {
        ...
        pallet_detected_sub = this->create_subscription<std_msgs::msg::Bool>("/pallet_detected", qos, std::bind(&VelocityAndSteeringPublisher::pallet_detected_callback, this, std::placeholders::_1));
