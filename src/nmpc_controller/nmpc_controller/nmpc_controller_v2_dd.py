...
MAX_VELOCITY = 0.5  # Define a maximum velocity limit
...
class RobotClient(Node):
    def __init__(self):
        ...
        self.declare_parameter('path_file', '/home/fbots/Nichiyu_RT/src/load_transporter_node/load_transporter_node/constructed_rs_path.pkl')
