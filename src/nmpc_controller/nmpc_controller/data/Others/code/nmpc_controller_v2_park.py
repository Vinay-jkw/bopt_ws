...
MAX_VELOCITY = 0.2  # Define a maximum velocity limit
...
class RobotClient(Node):
    ...
    def follow_path(self):
        ...
        if self.pallet_loaded or self.goal_reached:# or not self.path_received or self.pallet_detected:
