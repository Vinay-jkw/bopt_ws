...
SLOW_DOWN_DISTANCE = 2.5 # Distance within which the robot starts to slow down
...
class RobotClient(Node):
    ...
    def get_target_point(self, robot_x, robot_y):
        ...
        curvature = self.calculate_curvature(0.3)
    ...
    def calculate_safe_velocity(self, cv, steering_angle):
        ...
        safe_velocity = 1.0 * cv * (1 / (1 + np.exp(-(0.88 * np.sqrt(mu * (g / abs(curvature)))))))
