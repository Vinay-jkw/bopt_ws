...
MAX_VELOCITY = 0.4 # Define a maximum velocity limit
...
class RobotClient(Node):
    def __init__(self):
        ...
        self.declare_parameter('set_max_speed', 0.4)
    ...
    def set_parameters(self, path_file, goal_tolerance, set_max_speed):
        global MAX_VELOCITY
        self.goal_tolerance = goal_tolerance    
        self.path_file = path_file
        MAX_VELOCITY = set_max_speed
        ...
        self.get_logger().info(f'MAX_SPEED is set to: {MAX_VELOCITY}')
...
def main(args=None):
    ...
    parser.add_argument('--set_max_speed', type=float, default=0.4, help='max speed')
    ...
    client.set_parameters(
        ...
        set_max_speed=parsed_args.set_max_speed
    )
