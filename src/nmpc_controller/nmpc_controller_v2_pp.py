...
MAX_VELOCITY = 0.25  # Define a maximum velocity limit
...
class RobotClient(Node):
    def __init__(self):
        ...
        with open('/home/fbots/bopt_v2_ws/src/nmpc_controller/nmpc_controller/mpc_lookup_table_1.36.pkl', 'rb') as f:
