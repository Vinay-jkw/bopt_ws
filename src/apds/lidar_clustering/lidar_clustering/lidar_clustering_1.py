...
class LidarClusteringNode(Node):
    def __init__(self):
        ...
        self.cluster_pub = self.create_publisher(String, 'map1', 10)  # New publisher for clusters
        ...
        self.translation = (-0.18, 0)  # base_laser_1 to base_link translation(right)
        self.rotation = (0, 0, 0)    # base_laser_1 to base_link rotation
    ...
    def publish_cluster_centers(self, cluster_centers_all_rois):
        ...
        #self.get_logger().info("Published cluster centers to 'map1' topic.")
