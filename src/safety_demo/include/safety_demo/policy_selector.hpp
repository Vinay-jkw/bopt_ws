// Selects the appropriate danger and warning policies from the loaded DB data based on speed, direction, and mode.
...
/**
 * @brief Class for selecting appropriate safety policies based on current conditions
 */
...
private:
    const std::map<int, std::multiset<Policy>>& policies_;  ///< Reference to policies map
